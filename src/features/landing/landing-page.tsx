    ...
    <main className="landing-shell">
      ...
      <section className="landing-hero">
        <div className="landing-copy">
          ...
          <div className="landing-actions"><Link className="landing-primary" href="/sign-in">Start building evidence <ArrowRight size={17} /></Link><a className="landing-secondary" href="#experience"><Play size={13} fill="currentColor" /> See how it works</a></div>
