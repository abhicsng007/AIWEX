    ...
    <main className="landing-shell">
      ...
      <section className="landing-hero">
        <div className="landing-copy">
          ...
          <div className="landing-actions"><Link className="landing-primary" href="/sign-in">Start building evidence <ArrowRight size={17} /></Link><Link className="landing-secondary" href="/demo?onboarding=1"><Play size={13} fill="currentColor" /> Try the demo</Link><Link className="landing-secondary" href="/demo/complete"><BadgeCheck size={13} /> Full journey showcase</Link><a className="landing-secondary" href="#experience">See how it works</a></div>
